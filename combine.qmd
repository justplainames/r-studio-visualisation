...
# Map of Indicator 1
## Select specific columns for mortality rate unintentional poisoning
```{r}
...
## Histogram of mortality rate unintential poisoning for year 2019
```{r}
...
## Histogram of population with basic handwashing facilities for year 2019
```{r}
...
## Map of population with basic handwashing facilities for year 2019
```{r}
...
## Map of mortality rate unintentional poisoning for year 2019
```{r}
...
## Map of population with basic handwashing facilities for urban areas
```{r}
...
## Map of population with basic handwashing facilities for rural areas
```{r}
...
## Map of mortality rate unintentional poisoning for male gender
```{r}
...
## Map of mortality rate unintentional poisoning for female gender
```{r}
# Replace NAs in 'gender' column
...
## Map of mortality rate unintentional poisoning for both gender
```{r}
# Replace NAs in 'gender' column
...
```{r}
mortality_rate_unsafe_water <- dplyr::select(
...
```{r}
proportion_of_safe_water <- dplyr::select(
